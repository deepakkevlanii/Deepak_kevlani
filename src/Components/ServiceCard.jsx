...
const ServiceCard = ({ imgsrc, title, description }) => {
  return (
    <div className="service-card relative bg-transparent p-8 rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 mb-5" style="width:100%;">
